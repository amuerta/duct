#ifndef __DT_CONFIG_H
#define __DT_CONFIG_H
...
#define DTVM_SCOPES                             128     /* Max resursive calls */
#define DTVM_OBJECT_MAP_CAPACITY                256     /* Maximum variables per stack */
#define DTVM_STACK_CAPACITY                     1024    /* In Objects */
